...
class DealerActivity : BaseActivity() {
    ...
    fun initLayout(){
        ...
        mBottom.addItemNav(ItemNav(this,R.mipmap.icon,"自營商買超前50名"))
        mBottom.addItemNav(ItemNav(this,R.mipmap.icon,"自營商賣超前50名"))
        mBottom.build()
    ...
    private fun getDealerBuy() {
        ...
        object : Thread() {
            override fun run() {
                super.run()
                try {
                    val doc = Jsoup.connect("https://histock.tw/stock/three.aspx?s=c").get()
    ...
    inner class MyAdapter(var mDatas: ArrayList<String>?) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (convertView == null)
                convertView = LayoutInflater.from(this@DealerActivity).inflate(
